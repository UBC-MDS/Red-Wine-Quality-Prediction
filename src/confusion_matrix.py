...
def main(model, x_test_path, y_test_path, output_file):
    ...
    --------
    >>> python confusion_matrix.py --model=../results/models/best_pipe.pickle --x_test_path=../results/tables/X_test.csv --y_test_path=../results/tables/y_test.csv --output_file=../img/correlation_matrix_plot.png
    """
